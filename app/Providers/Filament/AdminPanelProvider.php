...
class AdminPanelProvider extends PanelProvider
{
    ...
    {
        return base_path('Modules/'.$moduleName.'/app/Filament/Resources');
    }

    public function moduleNamespace(string $moduleName): string
    {
        return 'Modules\\'.$moduleName.'\\App\\Filament\\Resources';
    }
    ...
    public function panel(Panel $panel): Panel
    {
        return $panel
            ...
            ->discoverResources(in: $this->moduleDirectory('Pages'), for: $this->moduleNamespace('Pages'))
